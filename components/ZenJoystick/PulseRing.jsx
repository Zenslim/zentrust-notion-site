...
export default function PulseRing({ bp }) {
  const glowConfig = {
    bio: { color: "#facc15", position: "left-0 top-1/2 -translate-y-1/2" },
    psycho: { color: "#ef4444", position: "bottom-0 left-1/2 -translate-x-1/2" },
    social: { color: "#10b981", position: "right-0 top-1/2 -translate-y-1/2" },
    spiritual: { color: "#8b5cf6", position: "top-0 left-1/2 -translate-x-1/2" }
  }
